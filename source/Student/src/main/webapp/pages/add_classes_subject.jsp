...
<body>
	...
	<div class="main">
		<form action="/Student/AddCla2SubServlet" method="post">
			...
			<br /> <br />
			<p style="padding: 3px;">
				选 择 &nbsp; 班 级： <select id="cla_id" name="cla_id">
			...
			<p>
				选 择 主 讲 教 &nbsp;师： <select id="tec_id" name="tec_id">
			...
			<p>可选课程：</p>
			<br />
			<div id="select_able"></div>
			<p>已选课程：</p>
			<br />
			<div id="select_unable"></div>
			<br /> <input style="width: 65px; height: 30px;" type="submit"
				value=" 提 交 " />
		</form>
	</div>
</body>
